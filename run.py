...
if __name__ == '__main__':
    ...
    log.set_level(logging.DEBUG)  # 设置log级别
    # log.set_level_to_debug()     # 设置log级别的另外一种方法

    runner = TestRunner()
    # runner.add_case_dir("testcase/market_group")
    runner.add_case_dir("testcase/ark/ark_2")
    # runner.add_case_dir("testcase/ark")
